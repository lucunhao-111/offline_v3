...
insert overwrite table dws_trade_province_order_nd partition(dt='2022-09-16')
select
    province_id,
    province_name,
    area_code,
    iso_code,
    iso_3166_2,
    sum(if(dt>=date_add('2022-09-16',-6),order_count_1d,0)),
    sum(if(dt>=date_add('2022-09-16',-6),order_original_amount_1d,0)),
    sum(if(dt>=date_add('2022-09-16',-6),activity_reduce_amount_1d,0)),
    sum(if(dt>=date_add('2022-09-16',-6),coupon_reduce_amount_1d,0)),
    sum(if(dt>=date_add('2022-09-16',-6),order_total_amount_1d,0)),
    sum(order_count_1d),
...
where dt>=date_add('2022-09-16',-29)
and dt<='2022-09-16'
